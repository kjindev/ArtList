...
import SearchForm from "@/app/_common/SearchForm";
...
export function Total() {
  ...
  return (
    <div className="pc:w-[900px] w-[100%] h-[100vh] flex justify-center tems-center">
      <div className="w-[100%] flex flex-wrap-reverse pc:flex-nowrap items-center justify-center px-7">
        <div>
          <div className="pt-5 text-3xl pc:text-4xl font-bold mb-1">
            문화생활,
            <br /> 한 눈에 확인해보세요
          </div>
